    ...
    public static AiClient createForProvider(String provider, AiPreferencesUtils prefs) {
        switch(provider) {
            ...
            case AiConstants.AiProvider.CHATGPT:
                return new OpenAiCompatibleClient(prefs.getChatGptApiKey(), prefs.getChatGptModel(), AiConstants.ApiEndpoints.CHATGPT_BASE_URL, AiConstants.AiProvider.CHATGPT);
            case AiConstants.AiProvider.DEEPSEEK:
                return new OpenAiCompatibleClient(prefs.getDeepSeekApiKey(), prefs.getDeepSeekModel(), AiConstants.ApiEndpoints.DEEPSEEK_BASE_URL, AiConstants.AiProvider.DEEPSEEK);
