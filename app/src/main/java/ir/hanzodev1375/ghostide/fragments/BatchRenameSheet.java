...
public class BatchRenameSheet extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (files == null && getArguments() != null) {
            ...
            if (paths != null && names != null) {
                for (int i = 0; i < paths.size(); i++) {
                    FileManagerModel model = new FileManagerModel(paths.get(i), names.get(i), FileState.NONE, 0);
                    files.add(model);
                }
            }
        }
        ...
        com.google.android.material.switchmaterial.SwitchMaterial switchRegex = view.findViewById(R.id.switch_regex);
        ...
        btnApply.setOnClickListener(
                v -> {
                    String pattern = etPattern.getText() != null ? etPattern.getText().toString().trim() : "{P}{S}";
