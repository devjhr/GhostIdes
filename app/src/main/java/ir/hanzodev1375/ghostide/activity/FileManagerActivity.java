...
public class FileManagerActivity extends BaseCompat
    ...
    private Set<String> itemname = new HashSet<>(
    Arrays.asList(
            ".html",
            ".java",
            ".c",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bind.rvfiles.setLayoutManager(
                appsetting.getGridMod() ? new GridLayoutManager(this, appsetting.getGridSpanCount()) : new LinearLayoutManager(this));
                                ...
                                switch (index) {
                                    case 0 ->
                                            new MaterialAlertDialogBuilder(FileManagerActivity.this)
                                                    ...
                                                    .show();
                                    case 1 -> {
                                        RenameDialogFragment dialog = RenameDialogFragment.getInstance(
                                                item.getName(),
                                                (prefix, extension) -> {
                                                    String newName = (extension != null && !extension.isEmpty())
                                                            ? prefix + "." + extension
                                                            : prefix;
                                                    zipOp.renameEntry(
                                                            currentZipFilePath,
                    ...
                    ViewCompat.setOnApplyWindowInsetsListener(
                            ...
                            (view, insets) -> {
                                ...
                                if (imeHeight > 0) {
                                    ...
                                    targetBottomMargin = fabBottomMargin + (int) (8 * getResources().getDisplayMetrics().density);
                                }
    ...
    /**
     * Refreshes the git status of the repository that the current directory belongs to and
     * highlights files/folders with uncommitted changes in the file list. Call this whenever the
     * visible directory may have changed on disk (navigation, returning to the activity, after
     * commit/push, etc).
     */
                ...
                (view, insets) -> {
                    ...
                    bind.fab.post(
                            () -> {
                                ...
                                ViewGroup.MarginLayoutParams fabParams = (ViewGroup.MarginLayoutParams) bind.fab.getLayoutParams();
                    ...
                    menu.setOnMenuItemClickListener(
                            (index, item) -> {
                                switch (index) {
                                    ...
                                    case 2 ->
                                            FilePropertiesSheet.newInstance(Collections.singletonList(filemodel))
                                                    .show(getSupportFragmentManager(), FilePropertiesSheet.TAG);
                                    case 3 ->
                                            bookmarkViewModel.toggle(
                                                    filemodel.getPath(),
                                                    filemodel.getName(),
    ...
    void renameItem(FileManagerModel model) {
        RenameDialogFragment dialog = RenameDialogFragment.getInstance(
                model.getName(),
                (prefix, extension) -> {
                    String displayName = !TextUtils.isEmpty(extension) ? prefix + "." + extension : prefix;
    ...
    protected void onResume() {
        ...
        boolean spanChanged = currentGrid && (bind.rvfiles.getLayoutManager()
        ...
        menu.setOnMenuItemClickListener(
                (c, f) -> {
                    switch (c) {
                        ...
                        case 6 -> openSdCard();
                        case 7 ->
                                startActivity(new Intent(FileManagerActivity.this, StoreActivity.class));
                        case 8 ->
                                startActivity(new Intent(FileManagerActivity.this, AboutActivity.class));
                        case 9 -> StringsTranslatorSheet.newInstance(viewModel.getCurrentPath().getValue())
