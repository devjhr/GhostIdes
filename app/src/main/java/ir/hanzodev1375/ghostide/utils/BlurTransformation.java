...
public class BlurTransformation extends ir.hanzodev1375.ghostide.utils.BitmapTransformation {

  private static final int VERSION = 1;
  private static final String ID = "ir.hanzodev1375.ghostide.utils.BlurTransformation." + VERSION;
