...
import ir.hanzodev1375.components.effect.particle.DropParticle;
import ir.hanzodev1375.components.effect.particle.ExplosionParticle;
import ir.hanzodev1375.components.effect.particle.FloatParticle;
import ir.hanzodev1375.components.effect.particle.Particle;
...
public class SmashAnimator {
    ...
    /** 爆炸动画回调事件 */
    public abstract static class OnAnimatorListener {
     ...
     * 设置动画样式
     *
     * @param style {@link #STYLE_EXPLOSION},{@link #STYLE_DROP},{@link #STYLE_FLOAT_TOP},{@link
     *     #STYLE_FLOAT_BOTTOM},{@link #STYLE_FLOAT_LEFT},{@link #STYLE_FLOAT_RIGHT};
     * @return 链式调用，因此返回本身
     */
            ...
            for (int j = 0; j < col; j++) {
                ...
                switch (mStyle) {
                    case STYLE_EXPLOSION:
                        mParticles[i][
                        j] = new ExplosionParticle(color, mRadius, mRect, mEndValue, random, mHorizontalMultiple, mVerticalMultiple);
                        break;
                    case STYLE_DROP:
                        mParticles[i][
                        j] = new DropParticle(point, color, mRadius, mRect, mEndValue, random, mHorizontalMultiple, mVerticalMultiple);
                        break;
                    case STYLE_FLOAT_LEFT:
                        mParticles[i][
                        j] = new FloatParticle(FloatParticle.ORIENTATION_LEFT, point, color, mRadius, mRect, mEndValue, random, mHorizontalMultiple, mVerticalMultiple);
                        break;
                    case STYLE_FLOAT_RIGHT:
                        mParticles[i][
                        j] = new FloatParticle(FloatParticle.ORIENTATION_RIGHT, point, color, mRadius, mRect, mEndValue, random, mHorizontalMultiple, mVerticalMultiple);
                        break;
                    case STYLE_FLOAT_TOP:
                        mParticles[i][
                        j] = new FloatParticle(FloatParticle.ORIENTATION_TOP, point, color, mRadius, mRect, mEndValue, random, mHorizontalMultiple, mVerticalMultiple);
                        break;
                    case STYLE_FLOAT_BOTTOM:
                        mParticles[i][
                        j] = new FloatParticle(FloatParticle.ORIENTATION_BOTTOM, point, color, mRadius, mRect, mEndValue, random, mHorizontalMultiple, mVerticalMultiple);
                        break;
                }
            }
        }
