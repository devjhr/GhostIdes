...
public class YamlQuoteHandler implements QuickQuoteHandler {
  ...
  public HandleResult onHandleTyping(
    ...
    if (cursor.getStart().line != cursor.getEnd().line) return HandleResult.NOT_CONSUMED;

    if ("\"".equals(candidateCharacter) || "'".equals(candidateCharacter)) {
