...
public final class HtmlHelper {
  ...
  private static void initTags() {
    ...
    addTag("h1", "Heading level 1", CompletionItemKind.Function);
    addTag("h2", "Heading level 2", CompletionItemKind.Function);
    addTag("h3", "Heading level 3", CompletionItemKind.Function);
    addTag("h4", "Heading level 4", CompletionItemKind.Function);
    addTag("h5", "Heading level 5", CompletionItemKind.Function);
    addTag("h6", "Heading level 6", CompletionItemKind.Function);
    addTag("p", "Paragraph", CompletionItemKind.Function);
    ...
    addTag("span", "Generic inline container", CompletionItemKind.Function);

    addTag("a", "Anchor link", CompletionItemKind.Function);
    addTag("strong", "Strong importance", CompletionItemKind.Function);
    addTag("em", "Emphasis", CompletionItemKind.Function);
    addTag("b", "Bold text", CompletionItemKind.Function);
    addTag("i", "Italic text", CompletionItemKind.Function);
    addTag("u", "Underlined text", CompletionItemKind.Function);
    addTag("small", "Small text", CompletionItemKind.Function);
    addTag("mark", "Marked text", CompletionItemKind.Function);
    addTag("del", "Deleted text", CompletionItemKind.Function);
    addTag("ins", "Inserted text", CompletionItemKind.Function);
    addTag("sub", "Subscript", CompletionItemKind.Function);
    addTag("sup", "Superscript", CompletionItemKind.Function);
    addTag("code", "Code snippet", CompletionItemKind.Function);
    addTag("pre", "Preformatted text", CompletionItemKind.Function);
    addTag("q", "Inline quotation", CompletionItemKind.Function);
    addTag("blockquote", "Block quotation", CompletionItemKind.Function);
    addTag("cite", "Citation", CompletionItemKind.Function);
    addTag("abbr", "Abbreviation", CompletionItemKind.Function);
    addTag("address", "Contact address", CompletionItemKind.Function);
    addTag("time", "Date/time", CompletionItemKind.Function);

    addTag("ul", "Unordered list", CompletionItemKind.Function);
    addTag("ol", "Ordered list", CompletionItemKind.Function);
    addTag("li", "List item", CompletionItemKind.Function);
    addTag("dl", "Description list", CompletionItemKind.Function);
    addTag("dt", "Description term", CompletionItemKind.Function);
    addTag("dd", "Description details", CompletionItemKind.Function);

    addTag("table", "Table", CompletionItemKind.Class);
    addTag("caption", "Table caption", CompletionItemKind.Function);
    ...
    addTag("tr", "Table row", CompletionItemKind.Function);
    addTag("th", "Table header cell", CompletionItemKind.Function);
    addTag("td", "Table data cell", CompletionItemKind.Function);
    ...
    addTag("button", "Button", CompletionItemKind.Function);
    addTag("select", "Dropdown", CompletionItemKind.Function);
    addTag("option", "Option item", CompletionItemKind.Function);
    addTag("optgroup", "Option group", CompletionItemKind.Function);
    addTag("textarea", "Text area", CompletionItemKind.Function);
    addTag("label", "Label", CompletionItemKind.Function);
    addTag("fieldset", "Fieldset", CompletionItemKind.Class);
    addTag("legend", "Legend", CompletionItemKind.Function);
    addTag("datalist", "Data list", CompletionItemKind.Function);
    addTag("output", "Output", CompletionItemKind.Function);
    addTag("progress", "Progress bar", CompletionItemKind.Function);
    addTag("meter", "Meter", CompletionItemKind.Function);
    ...
    addTag("figcaption", "Figure caption", CompletionItemKind.Function);
    addTag("ruby", "Ruby annotation", CompletionItemKind.Function);
    addTag("rt", "Ruby text", CompletionItemKind.Function);
    addTag("rp", "Ruby parentheses", CompletionItemKind.Function);
    addTag("bdi", "Bi-directional isolation", CompletionItemKind.Function);
    addTag("bdo", "Bi-directional override", CompletionItemKind.Function);
