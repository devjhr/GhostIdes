...
public class PreferencesUtils {
    ...
    public boolean canCloseRelativeToFirstDepth() {
        var depth = getDefaultPreferences()
                .getString(
    ...
    public boolean flagEmptyLine() {
        Set<String> values = getDefaultPreferences()
                .getStringSet(
    ...
    public int getCurrentBufferSize() {
        var selected = getDefaultPreferences().getString(Constants.SharedPreferenceKeys.KEY_BUFFER_SIZE, "5");
        return Integer.parseInt(selected) * 1024;
    }

    public float getCurrentEditorLineHeight() {
        var selected = getDefaultPreferences()
    ...
    public int getCurrentEditorFont() {
        var selectedFont = getDefaultPreferences()
                .getString(
    ...
    public boolean isShowHiddenFiles() {
        return getDefaultPreferences().getBoolean(Constants.SharedPreferenceKeys.KEY_SHOW_HIDDEN_FILES, false);
    }
