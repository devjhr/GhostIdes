...
public class TypeScriptLexer extends TypeScriptLexerBase {
  public static final int STYLE_VSCODEBRACE = 1,
      MultiLineComment = 2,
      SingleLineComment = 3,
      ...
      BooleanLiteral = 57,
      DecimalLiteral = 58,
      HexIntegerLiteral = 59,
      OctalIntegerLiteral = 60,
      ...
      TemplateStringEscapeAtom = 133,
      TemplateStringStartExpression = 134,
      TemplateStringAtom = 135;
